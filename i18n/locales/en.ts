...
export default {
  ...
  home: {
    ...
    greetingSubtitle: {
      night: 'Rest well, breaks can wait',
      morning: 'Start your day with a stretch',
      earlyAfternoon: 'Perfect time for a midday break',
      lateAfternoon: 'Keep the momentum going',
      evening: 'Wind down with a gentle break',
      lateEvening: 'One more break before rest',
    },
    takeABreak: 'Take a Break',
    tapToStart: 'Tap to start a quick exercise',
