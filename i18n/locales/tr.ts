...
export default {
  ...
  home: {
    ...
    greetingSubtitle: {
      night: 'Iyi uykular, molalar bekleyebilir',
      morning: 'Gune bir esneme ile basla',
      earlyAfternoon: 'Oglen molasi icin mukemmel zaman',
      lateAfternoon: 'Ivmeyi korumaya devam',
      evening: 'Hafif bir mola ile rahatla',
      lateEvening: 'Dinlenmeden once bir mola daha',
    },
    takeABreak: 'Mola Ver',
    tapToStart: 'Hizli bir egzersiz baslatmak icin dokun',
